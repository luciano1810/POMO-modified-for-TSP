...
| **方法**      | **avg_no_aug_gap** | **avg_aug_gap**    |
| ------------- | ------------------ | ------------------ |
| pomo          | 3.753675687101596  | 2.3295677522537446 |
| pomo+eas      | 2.606789398951748  | 1.7105819444909276 |
| PE            | 2.349167984953783  | 1.4844728058607355 |
| PE+eas        | 1.9538188023803307 | 1.3350925851361237 |
| PE plus       | 2.3019193028509286 | 1.2252178155247422 |
| PE plus + eas | 1.7854199751578677 | 0.98501104474859   |

按 `avg_aug_gap` 排序：

1. **PE plus + eas** = `0.9850`
2. **PE plus** = `1.2252`
3. **PE+eas** = `1.3351`
4. **PE** = `1.4845`
5. **pomo+eas** = `1.7106`
...
## **各个 test case 的 aug_gap 对比**

| **Test case**   | **pomo**     | **pomo+eas** | **PE**   | **PE+eas**   | **PE plus**  | **PE plus + eas** |
| --------------- | ------------ | ------------ | -------- | ------------ | ------------ | ----------------- |
| kroC100         | 0.240975     | 0.024098     | 0.101210 | 0.000000     | 0.173502     | 0.024098          |
| kroB150         | 1.052430     | 0.677382     | 0.604669 | 0.252583     | 0.340605     | **0.088021**      |
| ch150           | **0.398284** | **0.398284** | 0.490196 | 0.413603     | 0.474877     | 0.444240          |
| pr299           | 13.983939    | 9.761159     | 6.961881 | 7.391422     | 6.258430     | **4.911706**      |
| pr124           | 0.077926     | 0.077926     | 0.227003 | **0.000000** | 0.105031     | **0.000000**      |
| kroA100         | 0.648435     | **0.178555** | 1.259280 | **0.178555** | 0.469881     | 0.239639          |
| kroA200         | 2.124762     | 1.917053     | 1.215609 | 0.963634     | 0.796786     | **0.592482**      |
| pr226           | 4.116015     | 3.604624     | 3.064614 | 3.521258     | **2.880464** | 3.069592          |
| kroE100         | 0.493928     | **0.466739** | 0.761283 | 0.629871     | 0.593620     | 0.480334          |
| eil101          | 0.158983     | **0.000000** | 0.158983 | **0.000000** | 0.158983     | **0.000000**      |
| **avg_aug_gap** | 2.329568     | 1.710582     | 1.484473 | 1.335093     | 1.225218     | **0.985011**      |

------

## **每个 test case 的最优方法**

| **Test case** | **最优方法**                      | **最优 aug_gap** |
| ------------- | --------------------------------- | ---------------- |
| kroC100       | PE+eas                            | 0.000000         |
| kroB150       | PE plus + eas                     | 0.088021         |
| ch150         | pomo / pomo+eas                   | 0.398284         |
| pr299         | PE plus + eas                     | 4.911706         |
| pr124         | PE+eas / PE plus + eas            | 0.000000         |
| kroA100       | pomo+eas / PE+eas                 | 0.178555         |
| kroA200       | PE plus + eas                     | 0.592482         |
| pr226         | PE plus                           | 2.880464         |
| kroE100       | pomo+eas                          | 0.466739         |
| eil101        | pomo+eas / PE+eas / PE plus + eas | 0.000000         |

------

## **合并结论**

- 从整体平均指标看，**PE plus + eas** 最强
- 从单实例看，**PE plus + eas** 在 `kroB150、pr299、kroA200` 上是单独最优
- **PE plus** 在 `pr226` 上最好
- **PE+eas** 在 `kroC100、pr124` 上表现很强
- **pomo+eas** 在 `kroA100、kroE100、eil101` 这些实例上仍然有竞争力
- 原始 **pomo** 只在 `ch150` 上保持并列最优，整体已经明显落后
